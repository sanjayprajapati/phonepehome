...
const BathroomThree = () => {
  ...
  const handleButtonPress = useCallback(() => {
    ...
    setTimeout(() => {
    if(btnText == 'on'){
      fetch(HOST+token+'&room=8&allpin=1', {
        method: 'POST',
        headers: {
      ...
      setIsOnn5('ON');
      setIsPinval5('0');
      AsyncStorage.setItem('BTHRTH_switchOnestatus', 'ON');
      AsyncStorage.setItem('BTHRTH_switchTwostatus', 'ON');
      AsyncStorage.setItem('BTHRTH_switchThreestatus', 'ON');
      AsyncStorage.setItem('BTHRTH_switchFourstatus', 'ON');
      AsyncStorage.setItem('BTHRTH_switchFivestatus', 'ON');
      AsyncStorage.setItem('BTHRTH_AllswitchStatus', 'off');
    }else {
      fetch(HOST+token+'&room=8&allpin=0', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      setIsOnn5('OFF');
      setIsPinval5('1');
      AsyncStorage.setItem('BTHRTH_switchOnestatus', 'OFF');
      AsyncStorage.setItem('BTHRTH_switchTwostatus', 'OFF');
      AsyncStorage.setItem('BTHRTH_switchThreestatus', 'OFF');
      AsyncStorage.setItem('BTHRTH_switchFourstatus', 'OFF');
      AsyncStorage.setItem('BTHRTH_switchFivestatus', 'OFF');
      AsyncStorage.setItem('BTHRTH_AllswitchStatus', 'on');
    }
 ...
 useEffect(() => {
  ...
  //getToken();
 // toggleSwitch();
    AsyncStorage.getItem('BTHRTH_switchOnestatus').then(value => {
      if (value === 'ON') {        
        setIsOnn1('ON');
        setIsPinval1('0');
    ...
    AsyncStorage.getItem('BTHRTH_switchTwostatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BTHRTH_switchThreestatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BTHRTH_switchFourstatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BTHRTH_switchFivestatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BTHRTH_AllswitchStatus').then(value => {
      if (value === 'off') {        
        setBtnText('off');
      } else {
        setBtnText('on');
  ...
  const switch1OnOff = ()=> {
    ...
    const finalrul = HOST+token+'&room=8&switch1='+isPinval1;
  ...
  const switch2OnOff = ()=> {
   ...
   setTimeout(()=> {
        ...
        if(isOnn2 == 'ON') {
          ...
          const finalrul = HOST+token+'&room=8&switch2='+isPinval2;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
   ...
   setTimeout(()=>{
    ...
    if(isOnn3 == 'ON') {
      ...
      AsyncStorage.setItem('BTHRTH_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=8&switch3='+isPinval3;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
  ...
  const switch4OnOff = ()=> {
    ...
    if(isOnn4 == 'ON') {
      ...
      AsyncStorage.setItem('BTHRTH_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=8&switch4='+isPinval4;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
   ...
   setTimeout(()=> {
    ...
    if(isOnn5 == 'ON') {
      ...
      AsyncStorage.setItem('BTHRTH_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=8&switch5='+isPinval5;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
    ...
    <View style={styles.container}>
     ...
     <TouchableOpacity 
          ...
          <FontAwesome name="long-arrow-left" size={24} color="#fff"  />
            ...
            <Text style={styles.pageTitle}>Bath Room Three</Text>
            <SpinnerButton
