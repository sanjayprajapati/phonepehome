...
const BedroomFour = ({navigation}) => {
  ...
  const handleButtonPress = useCallback(() => {
    ...
    setTimeout(() => {
    if(btnText == 'on'){
      fetch(HOST+token+'&room=9&allpin=1', {
        method: 'POST',
        headers: {
      ...
      setIsOnn5('ON');
      setIsPinval5('0');
      AsyncStorage.setItem('BRF_switchOnestatus', 'ON');
      AsyncStorage.setItem('BRF_switchTwostatus', 'ON');
      AsyncStorage.setItem('BRF_switchThreestatus', 'ON');
      AsyncStorage.setItem('BRF_switchFourstatus', 'ON');
      AsyncStorage.setItem('BRF_switchFivestatus', 'ON');
      AsyncStorage.setItem('BRF_AllswitchStatus', 'off');
    }else {
      fetch(HOST+token+'&room=9&allpin=0', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json',
      ...
      setIsOnn5('OFF');
      setIsPinval5('1');
      AsyncStorage.setItem('BRF_switchOnestatus', 'OFF');
      AsyncStorage.setItem('BRF_switchTwostatus', 'OFF');
      AsyncStorage.setItem('BRF_switchThreestatus', 'OFF');
      AsyncStorage.setItem('BRF_switchFourstatus', 'OFF');
      AsyncStorage.setItem('BRF_switchFivestatus', 'OFF');
      AsyncStorage.setItem('BRF_AllswitchStatus', 'on');
    }
 ...
 useEffect(() => {
  ...
  //getToken();
 // toggleSwitch();
    AsyncStorage.getItem('BRF_switchOnestatus').then(value => {
      if (value === 'ON') {        
        setIsOnn1('ON');
        setIsPinval1('0');
    ...
    AsyncStorage.getItem('BRF_switchTwostatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRF_switchThreestatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRF_switchFourstatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRF_switchFivestatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRF_AllswitchStatus').then(value => {
      if (value === 'off') {        
        setBtnText('off');
      } else {
        setBtnText('on');
  ...
  const switch1OnOff = ()=> {
    ...
    const finalrul = HOST+token+'&room=9&switch1='+isPinval1;
  ...
  const switch2OnOff = ()=> {
   ...
   setTimeout(()=> {
        ...
        if(isOnn2 == 'ON') {
          ...
          const finalrul = HOST+token+'&room=9&switch2='+isPinval2;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
   ...
   setTimeout(()=>{
    ...
    if(isOnn3 == 'ON') {
      ...
      AsyncStorage.setItem('BRF_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=9&switch3='+isPinval3;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
  ...
  const switch4OnOff = ()=> {
    ...
    if(isOnn4 == 'ON') {
      ...
      AsyncStorage.setItem('BRF_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=9&switch4='+isPinval4;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
   ...
   setTimeout(()=> {
    ...
    if(isOnn5 == 'ON') {
      ...
      AsyncStorage.setItem('BRF_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=9&switch5='+isPinval5;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
    ...
    <View style={styles.container}>
     ...
     <TouchableOpacity 
          ...
          <FontAwesome name="long-arrow-left" size={24} color="#fff"  />
            ...
            <Text style={styles.pageTitle}>Bed Room Four</Text>
            <SpinnerButton
