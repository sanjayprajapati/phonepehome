...
const BedroomOne = ({navigation}) => {
  ...
  const handleButtonPress = useCallback(() => {
    ...
    if(btnText == 'on'){
      ...
      setIsOnn5('ON');
      setIsPinval5('0');
      AsyncStorage.setItem('BRO_switchOnestatus', 'ON');
      AsyncStorage.setItem('BRO_switchTwostatus', 'ON');
      AsyncStorage.setItem('BRO_switchThreestatus', 'ON');
      AsyncStorage.setItem('BRO_switchFourstatus', 'ON');
      AsyncStorage.setItem('BRO_switchFivestatus', 'ON');
      AsyncStorage.setItem('BRO_AllswitchStatus', 'off');
    }else {
      ...
      setIsOnn5('OFF');
      setIsPinval5('1');
      AsyncStorage.setItem('BRO_switchOnestatus', 'OFF');
      AsyncStorage.setItem('BRO_switchTwostatus', 'OFF');
      AsyncStorage.setItem('BRO_switchThreestatus', 'OFF');
      AsyncStorage.setItem('BRO_switchFourstatus', 'OFF');
      AsyncStorage.setItem('BRO_switchFivestatus', 'OFF');
      AsyncStorage.setItem('BRO_AllswitchStatus', 'on');
    }
 ...
 useEffect(() => {
  ...
  //getToken();
 // toggleSwitch();
    AsyncStorage.getItem('BRO_switchOnestatus').then(value => {
      if (value === 'ON') {        
        setIsOnn1('ON');
        setIsPinval1('0');
    ...
    AsyncStorage.getItem('BRO_switchTwostatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRO_switchThreestatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRO_switchFourstatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRO_switchFivestatus').then(value => {
      if (value === 'ON') {
    ...
    AsyncStorage.getItem('BRO_AllswitchStatus').then(value => {
      if (value === 'off') {        
        setBtnText('off');
      } else {
        setBtnText('on');
  ...
  const switch1OnOff = ()=> {
    ...
    const finalrul = HOST+token+'&room=3&switch1='+isPinval1;
  ...
  const switch2OnOff = ()=> {
   ...
   setTimeout(()=> {
        ...
        if(isOnn2 == 'ON') {
          ...
          const finalrul = HOST+token+'&room=3&switch2='+isPinval2;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
   ...
   setTimeout(()=>{
    ...
    if(isOnn3 == 'ON') {
      ...
      AsyncStorage.setItem('BRO_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=3&switch3='+isPinval3;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
  ...
  const switch4OnOff = ()=> {
    ...
    if(isOnn4 == 'ON') {
      ...
      AsyncStorage.setItem('BRO_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=3&switch4='+isPinval4;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
   ...
   setTimeout(()=> {
    ...
    if(isOnn5 == 'ON') {
      ...
      AsyncStorage.setItem('BRO_AllswitchStatus', 'on');
          ...
          const finalrul = HOST+token+'&room=3&switch5='+isPinval5;
          console.log(finalrul)
          fetch(finalrul, {
            method: 'POST',
            headers: {
    ...
    <View style={styles.container}>
     ...
     <TouchableOpacity 
          ...
          <FontAwesome name="long-arrow-left" size={24} color="#fff"  />
            ...
            <Text style={styles.pageTitle}>Bed Room One</Text>
            <SpinnerButton
