      ...
      <View style={styles.row1}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('SwitchController',{
            roomName: 'Bedroom 4',
            roomNum: 'room_10',
            url: 'http://origin8solutions.com/switches.php?apikey='+token+'&room=room_10',
          })}
          style={styles.col1}>
          <Image source={require('../assets/images/bedroom.png')} />
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('SwitchController',{
            roomName: 'Bathroom 4',
            roomNum: 'room_11',
            url: 'http://origin8solutions.com/switches.php?apikey='+token+'&room=room_11',
          })}
          style={styles.col1}>
          <Image source={require('../assets/images/bathroom.png')} />
